...
class Forms::QuestionsControllerTest < ActionController::TestCase
  ...
  test "should create forms_question" do
    assert_difference('Forms::Question.count') do
      post :create, forms_question: { forms_field_type_id: @forms_question.forms_field_type_id, forms_set_id: @forms_question.forms_set_id, position: @forms_question.position, title: @forms_question.title }
    end
  ...
  test "should update forms_question" do
    patch :update, id: @forms_question, forms_question: { forms_field_type_id: @forms_question.forms_field_type_id, forms_set_id: @forms_question.forms_set_id, position: @forms_question.position, title: @forms_question.title }
    assert_redirected_to forms_question_path(assigns(:forms_question))
  end
