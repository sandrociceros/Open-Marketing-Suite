...
class Forms::ResponsesControllerTest < ActionController::TestCase
  ...
  test "should create forms_response" do
    assert_difference('Forms::Response.count') do
      post :create, forms_response: { field_type_id: @forms_response.field_type_id, question_id: @forms_response.question_id, submission_id: @forms_response.submission_id, value: @forms_response.value }
    end
  ...
  test "should update forms_response" do
    patch :update, id: @forms_response, forms_response: { field_type_id: @forms_response.field_type_id, question_id: @forms_response.question_id, submission_id: @forms_response.submission_id, value: @forms_response.value }
    assert_redirected_to forms_response_path(assigns(:forms_response))
  end
