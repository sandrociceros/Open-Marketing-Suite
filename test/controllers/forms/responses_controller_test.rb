...
class Forms::ResponsesControllerTest < ActionController::TestCase
  ...
  test "should create forms_response" do
    assert_difference('Forms::Response.count') do
      post :create, forms_response: { forms_field_type_id: @forms_response.forms_field_type_id, forms_question_id: @forms_response.forms_question_id, forms_set_id: @forms_response.forms_set_id, response_text: @forms_response.response_text }
    end
  ...
  test "should update forms_response" do
    patch :update, id: @forms_response, forms_response: { forms_field_type_id: @forms_response.forms_field_type_id, forms_question_id: @forms_response.forms_question_id, forms_set_id: @forms_response.forms_set_id, response_text: @forms_response.response_text }
    assert_redirected_to forms_response_path(assigns(:forms_response))
  end
